...
$(document).ready(function(){
	...
	$('#preferences').submit(function(e) {
		...
		/*
		 * Temporarily do not require user profile
		 * 05/03/2015
		 *
	...
	/** Prevent submit of incomplete product form **/
	$('#productPage1').submit(function(e) {
		if($('#link_input').val() === '') {
			e.preventDefault();
			$('#errors').html('You need to enter a link to your product before continuing to the next page!');
		}
	});

	$('#productPage2').submit(function(e) {
