			...
			<div class="col-md-8 col-md-offset-2">
				@if($step['step'] === 1)
					<div class="text-left">
						...
						<p><strong>If you are not a Prime member, select only <em>standard</em> shipping. We currently reimburse only standard shipping costs to the continental United States.</p>
